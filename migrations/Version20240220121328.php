 ...
 */
final class Version20240220121328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE news (id INT AUTO_INCREMENT NOT NULL, status INT DEFAULT NULL, highlighted INT DEFAULT NULL, date DATE DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, short_description VARCHAR(255) DEFAULT NULL, youtube_video_code VARCHAR(255) DEFAULT NULL, full_description LONGTEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, img_updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', language INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
